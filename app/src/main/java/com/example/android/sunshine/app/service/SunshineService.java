...
/**
 * Created by chaudharyp on 23/1/16.
 */
        ...
        try {
            ...
            if ( cVVector.size() > 0 ) {
                ...
                this.getContentResolver()
                        .bulkInsert(WeatherContract.WeatherEntry.CONTENT_URI, cVVector.toArray(values));
            }
    ...
    long addLocation(String locationSetting, String cityName, double lat, double lon) {
        ...
        Cursor cursor = this.getContentResolver()
                                .query(WeatherContract.LocationEntry.CONTENT_URI,
                                       new String[]{WeatherContract.LocationEntry
                                               ._ID}, selection, new String[]{locationSetting}, null);
        ...
        if (!cursor.moveToFirst()) {
            ...
            Uri locationUri = this.getContentResolver()
